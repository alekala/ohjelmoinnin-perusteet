# -*- coding: utf-8 -*-
# 001 Muuttujat ja tyypit

# Luo riville 5 numero-tyyppinen muuttuja, jonka nimi on age ja sen arvo on oma ikäsi.


# Luo riville 8 lanka-tyyppinen muuttuja, jonka nimi on name ja sen arvo on oma nimesi.
...
# age: <oma ikäsi> (numero)
# name: <oma nimesi> (lanka)
# favourite_animals: <lempi eläimesi> (lista)
# vacation_kept: False (totuusarvo)
